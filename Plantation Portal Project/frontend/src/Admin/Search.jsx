            ...
            <div className="container">
              ...
              <div className="row row-30 justify-content-center">
                {MatchProducts.length !== 0 && (
                  <>
                    <h4 style={{ textAlign: "left" }} className="text-primary">
                      {MatchProducts.length} Products found related to "
                      {searchkey}"{" "}
                    </h4>
                    <br />
                    {MatchProducts.map((product, index) => {
                      return (
                        <div
                          className="col-md-6 col-lg-4 col-xl-4 wow fadeInRights"
                          style={{ maxHeight: "400px", height: "400px", width: "300px", maxWidth:"300px" }}
                          key={index}
                        >
                ...
                {MatchServices.length !== 0 && (
                  <>
                    <h4 style={{ textAlign: "left" }} className="text-primary">
                      {MatchServices.length} Services found related to "
                      {searchkey}"{" "}
                    </h4>
