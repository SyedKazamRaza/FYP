            ...
            <div className="col-lg-12">
              <div className="classic-blog blog-single">
                ...
                <div className="bs-blog-naz">
                  <div className="bs-blog-type"><i className="fa fa-pencil-square-o"></i></div>
                  <h2 className="text-primary"><Link to="#">{blog.title}</Link></h2>
                  <div className="bs-blog-detail">8 February 2022 - 11:30 AM, by Admin</div>     
