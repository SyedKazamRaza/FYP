          ...
          <div className="col-xl-7">
            ...
            <ul className="list-ordered">
              <li>
                ...
                at the time of delivery, please raise a return request on our
                website. Return request must be raised within 7 days from the
                date of delivery.
              </li>
            ...
            <p>
              ...
              damaged product to us on our gien The shipping fee is not
              refundable and only the amount paid by you for the product will be
              refunded.
            </p>
            <ul classNameName="list-ordered">
              ...
              <li>
                While refunding you can either choose exchange of product or
                total refund of your money
              </li>
              <li>
              ...
              <li>
                New product(s) will be delivered to you within 10 days of after
                we receive the product
              </li>
              <li>
                The refund amount will be transferred to you within 5 working
                days after we receive the refund request alongwith the product.
              </li>
            </ul>
          </div>
        </div>
