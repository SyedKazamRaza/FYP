                ...
                <div className="card-body">
                  ...
                  <ul style={{ listStyleType: "disc !important" }}>
                    ...
                    <li className="listStyling">
                      It can be planted outdoor as well as indoor.
                    </li>
                    <li className="listStyling">Improves skin</li>
                  </ul>
                  <br />
                  ...
                  {location.state.product.category === "plants" ? (
                    <div>
                      ...
                      <ul>
                        <li className="listStyling">Bright indirect light</li>
                        <li className="listStyling">Water Moderately</li>
                        <li className="listStyling">
                          Place Low Light Plants in Bathrooms
                        </li>
                        <li className="listStyling">
                        ...
                        <li className="listStyling">
                          Cleaning your plant after regular interval
                        </li>
                        <li className="listStyling">
