          ...
          <div className="container">
            <div className="row row-40 justify-content-between">
                ...
                <div className="oh-desktop">
                  <div className="wow slideInRight" data-wow-delay="0s">
                    <div className="footer-brand">
                      <Link to="index.html">
                        <img
                          src={"/images/logooB-removebg-preview.png"}
                          alt=""
                          width="196"
                          height="42"
                        />
                    ...
                    <p>
                      Fine Living is an organic farm located in Lahore. We offer
                      a wide range of plants, services, equipment, and
                    ...
                    <ul className="footer-contacts d-inline-block d-md-block">
                      <li>
                        <div className="unit unit-spacing-xs">
                          ...
                          <div className="unit-body">
                            <Link className="link-phone" to="tel:#">
                              0303-8920413
                            </Link>
                          </div>
                        </div>
                      ...
                      <li>
                        <div className="unit unit-spacing-xs">
                          ...
                          <div className="unit-body">
                            <Link className="link-location" to="#">
                              Plot 8, Block E, Model Town, Lahore
                            </Link>
                          </div>
                        </div>
                      </li>
              ...
              <div className="col-sm-6 col-lg-4 col-xl-4">
                <div className="oh-desktop">
                  <div
                    className="inset-top-18 wow slideInDown"
                    data-wow-delay="0s"
                  >
                    <h5>Newsletter</h5>
                    ...
                    >
                      <div className="form-wrap">
                        ...
                        <label
                          ...
                          htmlFor="subscribe-form-5-email"
                        >
                          Enter Your E-mail
                        </label>
                      </div>
                      <button
                        className="button button-block button-white"
                        type="submit"
                      >
                        Subscribe
                      </button>
                    ...
                    <div className="group-lg group-middle">
                      ...
                      <div>
                        <ul className="list-inline list-inline-sm footer-social-list-2">
                          <li>
                            <Link className="icon fa fa-facebook" to="#"></Link>
                          </li>
                          <li>
                            <Link className="icon fa fa-twitter" to="#"></Link>
                          </li>
                          <li>
                            <Link
                              className="icon fa fa-google-plus"
                              to="#"
                            ></Link>
                          </li>
                          <li>
              ...
              <div className="col-lg-3 col-xl-3">
                <div className="oh-desktop">
                  <div
                    className="inset-top-18 wow slideInLeft"
                    data-wow-delay="0s"
                  >
                    <h5>Quick Links</h5>
                    <div
