    ...
    <div className="breadcrumbs-custom context-dark bg-overlay-39">
      <div className="container">
        ...
        <ul className="breadcrumbs-custom-path">
          ...
          <div className="box-position"><img alt="" src="../images/terms-and-conditions.jpg"/></div>
        </div>
          <div className="row row-40 flex-lg-row-reverse justify-content-xl-between">
          <h3>Terms and Conditions</h3>
          <div className="row row-40 flex-lg-row-reverse">
            <p>
              Welcome to FineLiving also hereby known as “we", "us" or "FineLiving". We are an online marketplace and our terms and conditions govern your access and use of FineLiving along with its related sub-domains, sites, services and tools. By using this Site, you hereby accept these terms and conditions (including the linked information herein) and represent that you agree to comply with these terms and conditions (the "User Agreement"). This User Agreement is deemed effective upon your use of the Site which signifies your acceptance of these terms. If you do not agree to be bound by this User Agreement please do not access, register with or use this Site.
              <br /><br />
              ...
              <ul className="list-marked">
                <li>
                  Please ensure that the details you provide us with are correct and complete at all times. You are obligated to update details about your account in real time by accessing your account online. For pieces of information you are not able to update by accessing Your Account on the Site, you must inform us via our customer service communication channels to assist you with these changes. We reserve the right to refuse access to the Site, terminate accounts, remove or edit content at any time without prior notice to you. 
                </li>
                <li>
